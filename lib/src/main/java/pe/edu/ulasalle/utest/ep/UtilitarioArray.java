...
/**
 * Utility for working with Java arrays.
 */
public class UtilitarioArray {

	private UtilitarioJson utilJson;
    ...
    public static <T> T[] shallowCopy(final T[] array) {
        ...
        UtilitarioArray.shallowCopy(new Integer[5]);
        return array.clone();
    }
     ...
     */
    public <T> String convertToJson(T[] array) {
    	if (array == null) {
    		return "";
    	}
    	sb = new StringBuilder();
    	sb.append(BRACK_OPEN);
    	for (int i = 0; i < array.length; i++) {
			sb.append(utilJson.toJson(array[i]));
			sb.append(COMMA);
		}
    	sb.append(BRACK_CLOSE);
    	return sb.toString();
    }
    
	public UtilitarioJson getUtilJson() {
		return utilJson;
	}

	public void setUtilJson(UtilitarioJson utilJson) {
