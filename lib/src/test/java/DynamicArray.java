...
public class DynamicArray<E> implements Iterable<E> {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("______ffff______");
        ...
        DynamicArray<String> names1 = new DynamicArray<>();
        names1.add("Peubes");
        names1.add("Marley");
        long cont;

        cont = names1.stream().count();
        System.out.println(names1.toString());
        
        names1.iterator().getClass();
        //System.out.println(names1.iterator().next().toString());
        System.out.println("______________");
        Iterator<String> a = names.iterator();
        System.out.println("______eeeee______");
        System.out.println(a.next().getClass());
        System.out.println("______eeeee______");
    }
}